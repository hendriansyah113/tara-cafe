...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 03 Feb 2025 pada 09.01
...
INSERT INTO `tbl_arus_kas` (`kd_transaksi`, `tipe`, `arus`, `total`, `waktu`, `operator`) VALUES
('1GMI4R0EUJATT2S', 'Pembayaran Kasir', 'masuk', 26250, '2024-12-24 04:44:50', ''),
('2452ELIXO9PRVER', 'Pembayaran Kasir', 'masuk', 26250, '2024-12-23 15:57:01', ''),
('635MOYZHPJ6VETH', 'Pembayaran Kasir', 'masuk', 26250, '2024-12-23 08:38:36', ''),
('ata1ukrd2hr2bqJ8Vwf9', 'Pengeluaran resto', 'keluar', 1500000, '2024-12-24 04:58:44', 'admin'),
('AZFG2DK9QRF50DZ', 'Pembayaran Kasir', 'masuk', 7350, '2024-12-23 13:22:42', ''),
('BXWXPNKJAIIVGBO', 'Pembayaran Kasir', 'masuk', 7350, '2024-12-23 08:33:44', ''),
('FVAO39KWDUQRNSM', 'Pembayaran Kasir', 'masuk', 26250, '2024-12-23 08:39:15', ''),
('GF4DFEGRELCRQ5J', 'Pembayaran Kasir', 'masuk', 26250, '2024-12-23 08:57:34', ''),
('kp9ckllNa3iJ2Sz', 'Pembayaran kasir', 'masuk', 26250, '2024-12-20 03:20:21', 'admin'),
('ORP1CSVGJV2AEW6', 'Pembayaran Kasir', 'masuk', 26250, '2024-12-23 08:42:21', ''),
('RF2OXYVHDG7GUEW', 'Pembayaran Kasir', 'masuk', 26250, '2024-12-23 08:53:58', ''),
('VPoiw5uAdfnRDst', 'Pembayaran kasir', 'masuk', 26250, '2024-12-02 17:38:47', 'admin'),
('zGqripBchHfslbr', 'Pembelian bahan baku resto', 'keluar', 10000, '2024-12-24 04:57:51', 'admin');
...
INSERT INTO `tbl_bahan_baku` (`kd_bahan`, `nama`, `deks`, `kategori`, `satuan`, `stok`, `aktif`) VALUES
('4751', 'Mie', 'Untuk Bahan Mie', 'Mie Instan', 'pcs', 4, '1');
...
INSERT INTO `tbl_meja` (`kd_meja`, `nama`, `deks`, `status`, `jlh_tamu`, `last_visit`) VALUES
('1151', 'Meja 1', 'Meja dekat dinding', 'leave', 0, '2025-01-20 23:24:27'),
('2819', 'Meja 2', 'Meja dekat Pintu Masuk', 'active', 0, '2025-01-20 23:26:34');
...
INSERT INTO `tbl_menu` (`kd_menu`, `nama`, `deks`, `kategori`, `satuan`, `harga`, `pic`, `total_dipesan`, `aktif`) VALUES
('08128922', 'Nasi Goreng Spesial', 'Nasi goreng spesial dengan tambahan topping sosis, nugget, dan udang', '1', 'porsi', 25000, '08128922.jpg', 2, '1'),
('11834652', 'Ramen', 'Ramen adalah hidangan mi khas Jepang yang disajikan dengan kuah kaldu kaya rasa.', '10', 'porsi', 35000, '11834652.jpg', 0, '1'),
('45446025', 'Tes Manis Dingin', 'Teh manis dingin ukuran sedang', '5', 'porsi', 7000, '45446025.jpg', 37, '1');
...
INSERT INTO `tbl_mitra` (`kd_mitra`, `nama`, `deks`, `alamat`, `pemilik`, `hp`, `aktif`, `tipe`) VALUES
('35144964', 'CV Es Indonesia', 'Toko Untuk Beli ES', 'jl. seth adji no.49, Palangka Raya', 'Nur Jaya', '0895341640045', '1', 'pemasok');
...
INSERT INTO `tbl_pelanggan` (`id_pelanggan`, `nama`, `alamat`, `no_hp`, `email`, `last_visit`) VALUES
('03541856', 'Fikri', 'zzzzzzzzz', '085252982733', 'hendriansyah113@gmail.com', '2024-12-23 13:38:38'),
('12953544', 'Muklis', 'wdwdd', '2323213221121', 'hendriansyah113@gmail.com', '2025-01-21 01:13:15'),
('18220107', 'ramos', 'wdwdd', '23232132121121', 'hendriansyah113@gmail.com', '2025-01-21 01:13:27'),
('25661603', 'Johan', 'zzzzzzzzz', '085252982722233', 'hendriansyah113@gmail.com', '2025-01-21 01:11:20'),
('28581316', 'pambudi', 'jl. seth adji no.49, Palangka Raya', '0895341640045', 'hendriansyah113@gmail.com', '2025-01-21 01:11:01'),
('31074875', 'Lalisa', 'wdwdd', '2323232211', 'hendriansyah113@gmail.com', '2025-01-21 01:12:54'),
('37798165', 'Muti', 'wdwdd', '23232322112', 'hendriansyah113@gmail.com', '2025-01-21 01:13:04'),
('38794370', 'adit', 'wdwdd', '232321232121121', 'hendriansyah113@gmail.com', '2025-01-21 01:13:40'),
('66240845', 'fina', 'hjbjbjhbjhb', '00909099', 'hjbbbhhbjhb', '2024-12-23 04:46:36'),
('68364958', 'andre', 'wdwdd', '232323', 'hendriansyah113@gmail.com', '2025-01-21 01:12:35'),
('76675924', 'fina2', 'jl. jati', '085252982733', 'jati@gmail.com', '2024-12-23 05:27:31'),
('76684882', 'budi', 'sacasc', '08973283', 'cacac', '2024-12-23 13:51:19'),
('84591587', 'Lisa', 'wdwdd', '23232322', 'hendriansyah113@gmail.com', '2025-01-21 01:12:43'),
('86721769', 'johan', 'wdwdd', '232321322112', 'hendriansyah113@gmail.com', '2025-01-21 01:11:47'),
('89532853', 'lina', 'efef', '0828726332', 'ssdfse', '2024-12-24 04:42:15'),
('cash', 'Cash (Pelanggan default)', '-', '-', '-', '2020-06-22 09:07:13');
...
INSERT INTO `tbl_pembayaran` (`kd_invoice`, `kd_pesanan`, `waktu`, `total`, `kd_promo`, `diskon`, `tax`, `total_final`, `tunai`, `kembali`, `operator`) VALUES
('12-03-2024-VPOI', 'VPoiw5uAdfnRDst', '2024-12-02 17:38:47', 25000, '', 0, 1250, 26250, 30000, 3750, 'admin'),
('12-20-2024-KP9C', 'kp9ckllNa3iJ2Sz', '2024-12-20 03:20:21', 25000, '', 0, 1250, 26250, 100000, 73750, 'admin'),
('12-23-2024-2452', '2452ELIXO9PRVER', '2024-12-23 15:57:01', 25000, '', 0, 1250, 26250, 26250, 0, ''),
('12-23-2024-635M', '635MOYZHPJ6VETH', '2024-12-23 08:38:36', 25000, '', 0, 1250, 26250, 26250, 0, ''),
('12-23-2024-AZFG', 'AZFG2DK9QRF50DZ', '2024-12-23 13:22:42', 7000, '', 0, 350, 7350, 7350, 0, ''),
('12-23-2024-BXWX', 'BXWXPNKJAIIVGBO', '2024-12-23 08:32:51', 7000, '', 0, 350, 7350, 7350, 0, ''),
('12-23-2024-FVAO', 'FVAO39KWDUQRNSM', '2024-12-23 08:39:15', 25000, '', 0, 1250, 26250, 26250, 0, ''),
('12-23-2024-GF4D', 'GF4DFEGRELCRQ5J', '2024-12-23 08:57:34', 25000, '', 0, 1250, 26250, 26250, 0, ''),
('12-23-2024-ORP1', 'ORP1CSVGJV2AEW6', '2024-12-23 08:42:21', 25000, '', 0, 1250, 26250, 26250, 0, ''),
('12-23-2024-RF2O', 'RF2OXYVHDG7GUEW', '2024-12-23 08:53:58', 25000, '', 0, 1250, 26250, 26250, 0, ''),
('12-24-2024-1GMI', '1GMI4R0EUJATT2S', '2024-12-24 04:44:50', 25000, '', 0, 1250, 26250, 26250, 0, '');
...
INSERT INTO `tbl_pembelian_bahan_baku` (`kd_pembelian`, `mitra`, `waktu`, `total`, `operator`) VALUES
('zGqripBchHfslbr', '35144964', '2024-12-24 04:57:51', 10000, 'admin');
...
INSERT INTO `tbl_pengeluaran` (`kd_pengeluaran`, `nama`, `deks`, `kategori`, `total`, `operator`, `waktu`) VALUES
('ata1ukrd2hr2bqJ8Vwf9', 'Gajih', 'Gajih Sari', 'gaji pegawai', 1500000, 'admin', '2024-12-24 04:58:44');
...
INSERT INTO `tbl_pesanan` (`kd_pesanan`, `pelanggan`, `tipe`, `jumlah_tamu`, `meja`, `waktu_masuk`, `waktu_selesai`, `operator`, `status`) VALUES
('kp9ckllNa3iJ2Sz', '28581316', 'dine_in', 2, '1151', '2024-12-23 17:08:07', '2024-12-20 03:20:21', 'admin', 'done'),
('VPoiw5uAdfnRDst', 'cash', 'dine_in', 1, '1151', '2024-12-02 17:38:47', '2024-12-02 17:38:47', 'admin', 'done');
...
INSERT INTO `tbl_promo` (`kd_promo`, `nama`, `deks`, `tipe`, `value`, `kuota`, `tanggal_expired`) VALUES
('370008', 'Jumat Berkah', 'Beli pada hari jumat diskon 30%', 'persen', 30, 2, '2024-12-31'),
('864826', 'khusus malam', 'malam', 'total_harga', 10000, 2, '2024-12-27');
...
INSERT INTO `tbl_setting` (`kd_setting`, `caption`, `deks`, `value`) VALUES
('alamat_resto', 'Alamat restoran', '', 'Jln. G Obos, No. 49, Kec. Jekan Raya, Kota Palangka Raya, Kalimantan Tengah 74111'),
('awal_pembukuan', 'Tahun awal pembukuan', '', '2020'),
('kode_pos', 'Kode Pos Resto', '', '20986'),
('logo_resto', 'Logo Restoran', '', 'logo.jpg'),
('nama_owner', 'Nama Owner Resto', '', 'SAFINA NURHIDAYANTI'),
('nama_resto', 'Nama restoran', 'Nama Restoran', 'Tara Cafe'),
('nomor_handphone', 'Nomor Handphone Restoran', '', '082272177099'),
('saldo_awal', 'Saldo awal resto', '', '1000000'),
('status_setting', 'Status Setting', '-', 'done'),
('tax', 'Pajak restoran', 'Tambahann pajak ketika pembayaran', '10');
...
INSERT INTO `tbl_transaksi` (`token_transaksi`, `kd_transaksi`, `arus`, `total`, `waktu`, `operator`) VALUES
('ot7EzrfZL2hA27cCpX85lnRxP', 'kp9ckllNa3iJ2Sz', 'masuk', 26250, '2024-12-20 03:20:21', 'admin'),
('zj8gYxq2zsQ7obMj5Dl1FBovp', 'VPoiw5uAdfnRDst', 'masuk', 26250, '2024-12-02 17:38:47', 'admin');
...
(1, 'admin', 'Safina Nurhidayanti', '$2y$10$BcD2s9XpSC9lqMXdD17Qw.cDyBms9JUZ36XcEDVKUl3lmOivSGYFe', 'admin', '2025-01-22 02:04:39'),
(2, 'kasir', 'kasir', '$2y$10$YcnV/mudgmKt5UhMcLWrBesOOg4TqpOrTnEqPouBQeas8rDx9MEF2', 'kasir', '2025-01-20 23:22:50'),
(3, 'pegawai', 'pegawai', '$2y$10$2xe1z5GLRl5HnDBjyhFVquwc1tvE8.lwHRh0HfnvKFSdgpSnVqZTG', 'kasir', '2025-01-20 23:22:34');
...
ALTER TABLE `tbl_setting`
  ADD PRIMARY KEY (`kd_setting`);

--
-- Indeks untuk tabel `tbl_transaksi`
--
ALTER TABLE `tbl_transaksi`
  ADD PRIMARY KEY (`token_transaksi`);
