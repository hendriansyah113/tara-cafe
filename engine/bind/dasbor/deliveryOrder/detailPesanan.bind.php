                    ...
                    <div style="text-align: center;">
                        <?php if ($data['status'] === 'order_masuk') { ?>
                            <a href='#!' class='btn btn-primary btn-lg btn-icon icon-left'
                                @click='prosesPesanan("<?= $data['kdPesanan']; ?>")'>
                                <i class='fas fa-sign-in-alt'></i> Proses Pesanan
                            </a>&nbsp;&nbsp;&nbsp;
                        <?php } elseif ($data['status'] === 'diproses') { ?>
                            <a href='#!' class='btn btn-success btn-lg btn-icon icon-left'
                                @click='setSelesai("<?= $data['kdPesanan']; ?>")'>
                                <i class='fas fa-check'></i> Set Pesanan Selesai
                            </a>&nbsp;&nbsp;&nbsp;
                        ...
                        <?php } else { ?>
                            <a href='#!' class="btn btn-warning btn-lg btn-icon icon-left"
                                @click='batalkanPesananAtc("<?= $data['kdPesanan']; ?>")'>
                            ...
                            <?php foreach ($data['itemPesanan'] as $ip) : ?>
                                ...
                                <tr>
                                    <td style='padding-top:8px;padding-bottom:15px;'>
                                        <img src='<?= STYLEBASE; ?>/dasbor/img/menu/<?= $menu; ?>.jpg'
                                            style='width: 120px;border-radius:12px;'><br />
                                        <b><?= $namaMenu; ?></b>
                                    </td>
