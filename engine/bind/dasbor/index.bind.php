            ...
            <nav class="navbar navbar-expand-lg main-navbar" id='divNavbar'>
                ...
                <ul class="navbar-nav navbar-right">
                    <li class="dropdown dropdown-list-toggle">
                        <a href="#!" @click='lihatNotifAtc' data-toggle="dropdown"
                            class="nav-link notification-toggle nav-link-lg beep" id='capNotif'><i
                                class="far fa-bell"></i></a>
                        <div class="dropdown-menu dropdown-list dropdown-menu-right">
                            <div class="dropdown-header">Notifikasi Resto {{capFlash}}</div>
                            <div class="dropdown-list-content dropdown-list-icons">
                                <a href="#!" @click='lihatNotifikasiAllAtc' class="dropdown-item dropdown-item-unread"
                                    v-for='ps in pesanan'>
                            ...
                            <div class="dropdown-footer text-center">
                                <a href="#!" @click='lihatNotifikasiAllAtc'>Lihat semua <i
                    ...
                    <li class="dropdown"><a href="#" data-toggle="dropdown"
                            ...
                            <div class="d-sm-none d-lg-inline-block">
                                Hi, <?= $data['username']; ?>
                                (<?= ($data['userTipe'] === 'admin') ? 'Pemilik Cafe' : 'Admin'; ?>)
                            </div>
                        </a>
