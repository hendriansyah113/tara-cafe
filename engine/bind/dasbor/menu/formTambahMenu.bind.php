<div id='divFormTambahMenu'>
    <form enctype="multipart/form-data" id='frmUpload'>
        <div>
            <a href='#!' class="btn btn-primary btn-icon icon-left" id='btnKembali' @click='kembaliAtc'><i
        ...
        <div class="row" style="margin-top: 15px;">
            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                ...
                <div class="form-group">
                    <label>Deks</label>
                    <textarea class="form-control" placeholder="Deksripsi menu" id='txtDeks' name="txtDeks"
