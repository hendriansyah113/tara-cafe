<ul class="sidebar-menu" style='margin-top:20px;'>
    ...
    <li><a class="nav-link" id='btnBantuan' href='#!' @click='bantuanAtc'><i class="fas fa-info-circle"></i>
            <span>Bantuan</span></a></li>
    <li><a class="nav-link" id='btnTentang' href='#!' @click='tentangAplikasiAtc'><i class="fas fa-heart"></i>
