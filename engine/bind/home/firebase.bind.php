...
<body>
    Nama : <input type="text" id='txtNama'> | Email : <input type="text" id='txtEmail'> | Bacotan : <input type="text"
        id='txtBacotan'> <br /><br />
    ...
    <div id='divBacotan'>
        ...
        <p>
        <ul>
            <li v-for='b in bacotan'>Nama : {{b.nama}} - Bacotan : {{b.bacotan}} | <a href='#!'
                    @click='hapus(b.key)'>Hapus</a></li>
        </ul>
        </p>
    </div>
