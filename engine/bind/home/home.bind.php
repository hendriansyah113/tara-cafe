...
<div id="content">
    ...
    <section class="section section-main section-main-2 bg-dark dark">
        <div id="section-main-2-slider" class="section-slider inner-controls">
            <!-- Slide -->
            <div class="slide">
                <div class="bg-image zooming"><img src="<?= STYLEBASE; ?>/home/img/slider/slider.jpg" alt="">
                </div>
                <div class="container v-center">
                    <h4 class="text-muted">Selamat datang di Tara Cafe</h4>
                    <h1 class="display-2 mb-2">Nikmati Hidangan Terbaik</h1>
                    <h4 class="text-muted mb-5">Tempat Ideal untuk Berkumpul dan Bekerja</h4>
                    <a href="<?= HOMEBASE; ?>home/selfservice" class="btn btn-outline-primary btn-lg"><span>Pesan
                            Sekarang</span></a>
                </div>
            </div>
        </div>
    ...
    <!-- Section - About -->
    <section class="section section-bg-edge" style="margin-top: 20px;" id="tentang">
        ...
        <div class="container">
            <div class="col-lg-5 col-lg-offset-7 col-md-9 offset-md-6">
                ...
                <h1>Memasak dan melayani dengan cinta ..</h1>
                ...
                <div class="blockquotes">
                    ...
                    <blockquote class="blockquote light animated" data-animation="fadeInLeft">
                        ...
                        <footer>
                            ...
                            <span class="name">Dinda Syafatira<span class="text-muted">,
                                    dinda8911@gmail.com</span></span>
                        </footer>
                    </blockquote>
                    <!-- Blockquote -->
                ...
                <div class="col-md-4">
                    ...
                    <div class="feature feature-1 mb-md-0">
                        ...
                        <div class="feature-content">
                            ...
                            <p class="text-muted mb-3">Yeah, makananmu sampai. Nikmati mudahnya pesanan di resto kami.
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <!-- Section - Offers -->
    <section class="section bg-light" id="promo">
        <div class="container">
            <h1 class="text-center mb-6">Penawaran Khusus</h1>
            <div class="carousel" data-slick='{"dots": true}'>
                <?php foreach ($data['dataPromo'] as $dp) : ?>
                    <!-- Special Offer -->
                    <div class="special-offer">
                        <img style="width: 40%;" src="<?= STYLEBASE; ?>/home/img/promo.heic" alt=""
    ...
    <!-- Section - Menu -->
    <section class="section pb-0" id="menu">
        <div class="container">
            <h1 class="mb-6">Menu Kami</h1>
        </div>
        ...
        <div class="menu-sample-carousel carousel inner-controls" data-slick='{
            ...
            <?php foreach ($data['dataMenu'] as $dm) : ?>
                ...
                <div class="menu-sample">
                    <a href="#!">
                        <img src="<?= STYLEBASE; ?>/dasbor/img/menu/<?= $dm['pic']; ?>" style="filter: blur(5px);" alt=""
                            class="image">
