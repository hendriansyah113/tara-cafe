        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 offset-lg-4">
                    <h1 class="mb-0">Menu Cafe</h1>
                    <h4 class="text-muted mb-0">Pilih berbagai menu yang ada di Cafe kami</h4>
                </div>
            </div>
        </div>
    </div>
                    ...
                    ?>
                        ...
                        <div id="<?= $km['nama']; ?>" class="menu-category">
                            <div class="menu-category-title">
                                <div class="bg-image">
                                    <img src="http://assets.suelo.pl/soup/img/photos/menu-title-burgers.jpg"
                                        alt="<?= $km['nama']; ?>">
                                </div>
                                    ...
                                    <?php foreach ($menu as $mn) : ?>
                                        <div class="col-lg-4 col-6">
                                            ...
                                            <div class="menu-item menu-grid-item">
                                                <img class="mb-4" src="<?= STYLEBASE; ?>/dasbor/img/menu/<?= $mn['pic']; ?>"
                                                    alt="">
                                                ...
                                                <div class="row align-items-center mt-4">
                                                    ...
                                                    <div class="col-sm-6 text-sm-right mt-2 mt-sm-0">
                                                        <a href='#!' class="btn btn-outline-secondary btn-sm module module-cart"
