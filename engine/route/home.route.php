...
class home extends Route
{
    ...
    public function deliveryOrderProses()
    {
        ...
        if ($cekHp === true) {
            ...
            $this->state($this->sn)->createOrder($kdPesanan, $kdPelanggan, $alamat, $waktu, $buktiBayarPath);
        } else {
            ...
            //save ke tabel delivery order
            $this->state($this->sn)->createOrder($kdPesanan, $idPelanggan, $alamat, $waktu, $buktiBayarPath);
        }
