...
class homeData
{
    ...
    public function createOrder($kdPesanan, $kdPelanggan, $alamat, $waktu, $buktiBayarPath)
    {
        $query = "INSERT INTO tbl_delivery_order VALUES(null, '$kdPesanan','$kdPelanggan','order_masuk', '$alamat','$waktu', '$buktiBayarPath')";
        $this->st->query($query);
        $this->st->queryRun();
    }
